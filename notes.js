...
function writeChildrenContext(ctx, options) {
    var code = '';
...
function writeMessage(ctx, options) {
    ...
    if (!options.noRead || !options.noWrite) {
        code += compileExport(ctx, options) + name + ': {\n';
    }
