...
const Tile_Envelope_readField = (tag, obj, pbf) => {
    ...
    else if (tag === 3) obj.int = pbf.readVarint(true), obj.value = "int";
    else if (tag === 4) obj.float = pbf.readFloat(), obj.value = "float";
    else if (tag === 5) obj.string = pbf.readString(), obj.value = "string";
};
const Tile_Envelope_read = (pbf, end) => pbf.readFields(Tile_Envelope_readField, {kv: {}, kn: {}, int: 0, value: null, float: 0, string: ""}, end);
const Tile_Envelope_write = (obj, pbf) => {
    ...
    if (obj.int) pbf.writeVarintField(3, obj.int);
    if (obj.float) pbf.writeFloatField(4, obj.float);
    if (obj.string) pbf.writeStringField(5, obj.string);
};
